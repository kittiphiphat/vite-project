<template>
  <narbars></narbars>
  <!-- อันที่1 -->
  <div class="navmenu" style="max-width:100%; margin-top: -3rem; ">
          <h1 class="headname">ข้อมูลสุขภาพ</h1> <br>
        </div>  
<div class="album py-0 bg-body-tertiary" style="margin-top: -3rem;">        
...
import narbars from '../views/HeaderPage.vue'
